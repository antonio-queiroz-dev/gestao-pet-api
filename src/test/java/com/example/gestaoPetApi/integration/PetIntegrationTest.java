...
public class PetIntegrationTest extends BaseIntegrationTest {
    ...
    private PetCreateDto criarPetCreatDto(String nome, Long tutorId) {
        return new PetCreateDto(nome, PetTipo.GATO, PetSexo.MACHO, 5,
    ...
    void deveBuscarPetPorIdExistente() {
        Pet petSalvo = criarESalvarPet("José caça rato", PetTipo.GATO, PetSexo.MACHO,
    ...
    void deveRetornarTodosPets() {
        ...
        criarESalvarPet("José caça rato", PetTipo.GATO, PetSexo.MACHO,
                5, new BigDecimal("4.0"), "Siames", tutorPadrao);
        criarESalvarPet("Mailina Santos", PetTipo.GATO, PetSexo.FEMEA,
    ...
    void deveBuscarPetDeUmTutorEspecifico() {
        ...
        criarESalvarPet("José caça rato", PetTipo.GATO, PetSexo.MACHO,
                5, new BigDecimal("4.0"), "Siames", tutorPadrao);
        criarESalvarPet("Thor Silva", PetTipo.GATO, PetSexo.MACHO,
                5, new BigDecimal("4.0"), "Siames", tutorPadrao);
        criarESalvarPet("Marilina", PetTipo.GATO, PetSexo.FEMEA,
                8, new BigDecimal("5.0"), "Siames", tutor2);
